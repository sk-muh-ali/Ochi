...
function Footers() {
  return (
    <div className="w-full flex h-screen  py-20 px-20  font-['Franklin_Gothic_Medium']">
      <div className="w-1/2 h-full flex flex-col justify-between">
        {/* Top Heading */}
        <div className="heading">
          <h1 className="text-[8vw] font-semibold uppercase leading-[9vw] -mb-10">
            Eye
          </h1>
          <h1 className="text-[8vw] font-semibold uppercase leading-[9vw] -mb-10">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className=" mt-25 flex">
          <div>
            <h1 className=" mb-4.5">S:</h1>
            {["Facebook", "Instagram", "TWitter", "Discord", "Contact"].map(
              (items, index) => (
                <a
                  key={index}
                  className={`  text-xl font-['Neue_Montreal'] capitalize block font-light `}
                >
                  {items}
                </a>
              )
            )}
            <h1 className=" mb-[1vw]  mt-[2vw] ">S:</h1>
            {["202-1965 W 4th Ave", "Vancouver, Canada"].map((items, index) => (
              <a
                key={index}
                className={`  text-xl font-['Neue_Montreal'] capitalize block font-light `}
              >
            ...
            <h1 className="mt-[2vw]">
              {["30 Chukarina St", "Lviv,Ukraine"].map((items, index) => (
                <a
                  key={index}
                  className={`text-xl font-['Neue_Montreal'] capitalize block font-light `}
                >
            ...
            <h1 className=" mb-[1vw]  mt-[2vw] ">E:</h1>
            {["Hello@Developer.com"].map((items, index) => (
              <a
                key={index}
                className={`  text-xl font-['Neue_Montreal'] capitalize block font-light `}
              >
          ...
          <div className=" ml-auto flex flex-col justify-center items-start">
